    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntriesBlogCategory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntriesBlogCategory_Categories_IdCategories",
                        column: x => x.IdCategories,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EntriesBlogCategory_EntriesBlog_IdEntriesBlog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntriesBlogCategory_IdCategories",
                table: "EntriesBlogCategory",
                column: "IdCategories");

            migrationBuilder.CreateIndex(
                name: "IX_EntriesBlogCategory_IdEntriesBlog",
                table: "EntriesBlogCategory",
